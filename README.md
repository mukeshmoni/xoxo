...
- Legecy Method
```bash
$ git clone https://github.com/zozo82897/MusicPlayer
$ cd MusicPlayer
...
For any kind of help join [our support group](https://github.com/zozo82897) or raise an [issue](https://github.com/zozo82897/MusicPlayer/issues).

## ✨ <a name="credits"></a>Credits

- [dawwgcodes](https://github.com/dawgcodes)  😬
